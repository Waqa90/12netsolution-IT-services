        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              <div className="bg-white w-32 h-24 rounded-lg flex items-center justify-center mx-auto mb-6 p-4">
                <img src="/westpac.PNG" alt="Westpac Bank" className="w-full h-full object-contain" />
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              <div className="bg-white w-32 h-24 rounded-lg flex items-center justify-center mx-auto mb-6 p-4">
                <img src="/mpaisa.PNG" alt="Mpaisa" className="w-full h-full object-contain" />
              </div>
