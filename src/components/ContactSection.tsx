...
export default function ContactSection() {
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-brand-900 to-brand-800 text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-12">
          <a
            href="#book"
            className="inline-block bg-white text-brand-900 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
          >
